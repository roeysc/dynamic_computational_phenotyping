jsPsych.plugins["numerosity-task"] = (function() {
	        ...
	        description: '[key to choose the left option, key to choose the right option]'
		      ...
		      description: "The length of fixation cross presentation between trials"
				...
				fixation_color: {
					...
					default: 'white',
					description: "The color of the feedback cross presented between trials"
				},
				response_duration: {
		      type: jsPsych.plugins.parameterType.INT,
		    ...
		    background_color: {
		      ...
		      description: "Specifies how the dot array should be controlled by, SA or radius"
				...
				image_below: {
					...
					pretty_name: "image below",
					default: "none",
					description: "Draws an image underneath the range of dots"
				}
	 }
}
	...
	plugin.trial = function(display_element, trial) {
		...
		// trial.image_below = assignParameterValue(trial.image_below, "none");
      ...
      ctx.stroke();
		...
		function generate_circles(){
			...
			var img = new Image(); // add an image below
			img.src = trial.image_below;
			img.onload = function() {
			  ctx.drawImage(img, left_x, left_y + rect_height+5);
				ctx.drawImage(img, right_x, right_y+rect_height+5);
