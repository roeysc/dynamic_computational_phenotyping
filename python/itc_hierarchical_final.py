...
if model == "independent":
    model = CmdStanModel(
        stan_file='/n/gershman_lab/users/Stan/1_code/publish_code/stan/final_independent_models/itc_hierarchical_independent_final.stan',
                         cpp_options={'STAN_THREADS': True})

elif model == "dynamical":
        model = CmdStanModel(
            stan_file='/n/gershman_lab/users/Stan/1_code/publish_code/stan/final_dynamical_models/itc_hierarchical_super_model_noWeights_noPrev_0effects_GQ_varExplained_PD_exo2.stan',
            cpp_options={'STAN_THREADS': True})
...
all_subjects = data_itc_all_weeks.subjectId
# make data frames
...
fit = model.sample(data=lg_data_stan, inits=0, chains=4, parallel_chains=2, threads_per_chain=16,
                   ...
                   output_dir='/n/gershman_lab/users/Stan/4_hierarchical/itc_hierarchical_parallel/with_default_sampler/',
