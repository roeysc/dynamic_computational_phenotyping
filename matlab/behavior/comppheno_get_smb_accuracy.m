...
%%
% Load the SMB data
fname = '/net/rcstorenfs02/ifs/rc_labs/gershman_lab/users/Stan/2_task_data_files/data_90_subs/final/smb_data_for_stan_90s_updatedRegressorsNov22_rescaled_signVoverTU.csv';
